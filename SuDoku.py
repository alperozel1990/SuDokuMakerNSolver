...
def recursive(itNum):
    ...
    # print("timeTab: \n", timeTab)
    # print("itNum: ", itNum)
    sttNum = int((81 - preStt - itNum + 1)/((81 - preStt - itNum/5 + 1)/1.9))
    frsChcNum = int((81 - preStt - itNum + 1)/((81 - preStt - itNum/5 + 1)/(8)))
    rngNum = int((81 - preStt - itNum + 1)/((81 - preStt - itNum/7 + 1)/6))
